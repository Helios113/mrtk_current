...
public class CellToTris : MonoBehaviour
{
    public static List<int> GetTrianglesFromData(List<int> Conn, List<int> Off, List<int> Types)
    {
        List<int> res = new List<int>();
        int index = 0;
        for (int i = 0; i < Off.Count; i++)
        {
            res.AddRange(GetTrianglesFromData(Conn.GetRange(index, Off[i] - index),Types[i]));
            index = Off[i];
        }
        return res;
    }
    ...
    public static List<int> GetTrianglesFromData(List<int> cell, int type)
    {
        switch (type)
        {
            ...
            case 21:
                break;
            case 22:
                return quadraticTriangle(cell);
            case 23:
                return quadraticQuad(cell);
            case 36:
                //TODO
                break;
            case 24:
